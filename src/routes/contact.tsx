...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with the YOMORA team for support, custom orders and enquiries.",
      },
      ...
      <section className="container-x mx-auto max-w-[1200px] py-12">
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-2">
          ...
          >
            ...
            <button
              disabled={sending}
              className="w-full bg-gold py-3 text-[11px] font-semibold tracking-[0.24em] text-onyx disabled:opacity-50"
            >
...
function Info({
  ...
  return (
    <div className="flex gap-4">
      <div className="grid h-10 w-10 place-items-center rounded-full border border-gold text-gold">
